...
app.post("/submit", (req, res) => {
  ...
  const randomOne = Math.floor(Math.random()*adj.length);
  console.log(randomOne);
  const randomTwo =Math.floor(Math.random()*adj.length);
  const randomName = adj[randomOne]+adj[randomTwo];
  console.log(`random name:${randomName}`);
  res.render("index.ejs",{random:randomName})
